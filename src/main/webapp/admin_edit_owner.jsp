...
<h1>[관리자 모드] 정보 수정</h1>
<form action="admin_update_owner.jsp" method="post" name="modify_form" onsubmit="return confirmModify()">
    <table>
        <tr>
        ...
        <tr>
            <td>사업자 등록번호</td>
            <td><input type="text" name="license" value="<%= owner.getLicenseNum()%>" ></td>
        </tr>
        <tr>
            <td>Email</td>
        ...
        <tr>
            <td>비밀번호 변경</td>
            <td><input type="text" name="password" value="<%= owner.getPassword() %>" required></td>
        </tr>
        <tr>
            <td>전화번호</td>
