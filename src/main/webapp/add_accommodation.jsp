...
<body>
<h1>새로운 숙소 추가</h1>
<form name="accommodationForm" action="insert_accommodation.jsp" method="post" onsubmit="return validateForm()">
    <table>
        <tr>
            <td>종류(Category):</td>
            <td>
        ...
        <tr>
            <td>별점(Rating):</td>
            <td><input type="text" name="rating" value="0.0" readonly></td>
        </tr>
        <tr>
